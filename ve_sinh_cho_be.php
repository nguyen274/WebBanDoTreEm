...
<body>
    <div id="tong">
        ...
        <div align="center" id="page">
            <div id="index">            
                <p><b><a href="Index.php">Trang chủ</a> <font color="#D1CBCB"> > </font> Vệ sinh cho bé</b></p>
            </div>
            <h4><font color="#E59604"><i>

            Gồm những vật dụng vệ sinh như khăn giấy, bô, bỉm, tã giấy, các loại sản phẩm dung dịch vệ sinh thích hợp cho trẻ.</i></font>
        </h4>
        <?php 
        // PHẦN XỬ LÝ PHP
        // BƯỚC 1: KẾT NỐI CSDL
        ...
        $result = mysqli_query($con, "SELECT * FROM san_pham where ma_dm = 5 LIMIT $start, $limit");
        ...
        <div class="show">
           ...
           if ($current_page > 1 && $total_page > 1){
            echo '<a href="ve_sinh_cho_be.php?page='.($current_page-1).'">Trước</a>  ';
        }
        ...
        for ($i = 1; $i <= $total_page; $i++){
            ...
            if ($i == $current_page){
                ...
                echo '<a href="ve_sinh_cho_be.php?page='.$i.'">'.$i.'</a>  ';
            }
        }
        
            // nếu current_page < $total_page và total_page > 1 mới hiển thị nút prev
        if ($current_page < $total_page && $total_page > 1){
            echo '<a href="ve_sinh_cho_be.php?page='.($current_page+1).'">Sau</a>  ';
        }
        ?>
    </div>
    <?php  
