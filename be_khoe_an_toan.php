...
<body>
    <div id="tong">
        ...
        <div align="center" id="page">
            <div id="index">            
                <p><b><a href="Index.php">Trang chủ</a> <font color="#D1CBCB"> > </font> Bé khỏe & An toàn</b></p>
            </div>
            <h4><font color="#E59604"><i>
                
            Nơi bán tủ thuốc gia đình, nhiệt kế cho bé, túi chườm, dụng cụ cho trẻ uống thuốc, dụng cụ đuổi bắt muỗi, vv...</i></font>
        </h4>
        <?php 
        // PHẦN XỬ LÝ PHP
        // BƯỚC 1: KẾT NỐI CSDL
        ...
        $result = mysqli_query($con, "SELECT * FROM san_pham where ma_dm = 6 LIMIT $start, $limit");
        ...
        <div class="show">
         ...
         if ($current_page > 1 && $total_page > 1){
            echo '<a href="be_khoe_an_toan.php?page='.($current_page-1).'">Trước</a>  ';
        }
        ...
        for ($i = 1; $i <= $total_page; $i++){
            ...
            if ($i == $current_page){
                ...
                echo '<a href="be_khoe_an_toan.php?page='.$i.'">'.$i.'</a>  ';
            }
        }
        
            // nếu current_page < $total_page và total_page > 1 mới hiển thị nút prev
        if ($current_page < $total_page && $total_page > 1){
            echo '<a href="be_khoe_an_toan.php?page='.($current_page+1).'">Sau</a>  ';
        }
        ?>
    </div>
    <?php  
